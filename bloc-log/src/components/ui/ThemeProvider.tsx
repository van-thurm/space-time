...
export function ThemeProvider({ children }: ThemeProviderProps) {
  ...
  const setTheme = useCallback((newTheme: Theme) => {
    ...
    localStorage.setItem('bloc-log-theme', newTheme);
    updateResolvedTheme(newTheme);
  }, [updateResolvedTheme]);

  // Initialize on mount
  useEffect(() => {
    const stored = localStorage.getItem('bloc-log-theme') as Theme | null;
    ...
    const handleSystemChange = () => {
      const currentStored = localStorage.getItem('bloc-log-theme') as Theme | null;
    ...
    const handleVisibilityChange = () => {
      if (document.visibilityState === 'visible') {
        const storedTheme = localStorage.getItem('bloc-log-theme') as Theme | null;
