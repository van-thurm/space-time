    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-10">
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl">what is a bloc?</h2>
          <p className="font-sans text-sm leading-relaxed text-foreground/90">
            a bloc (short for training block) is a focused chunk of training time where you pursue one primary goal
          ...
          <p className="font-sans text-sm leading-relaxed text-foreground/90">
            a bloc = X weeks of training built around a chosen priority: build muscle,
            build strength, peak, or rebuild. inside a bloc, sets, reps, and weight change
        ...
        {/* Block types table */}
        <section className="space-y-3">
          <h2 className="font-display text-2xl">how lifters use blocs</h2>
          ...
          <p className="font-sans text-sm leading-relaxed text-foreground/90">
            ...
            this framework. use blocs for mobility, improving your vertical, or even building
        ...
        {/* How to build */}
        <section className="space-y-3">
          <h2 className="font-display text-2xl">how to build a bloc</h2>
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-accent pl-4">
              ...
              <p className="font-sans text-sm text-muted">
                base/volume blocs focus on variation, compound lifts, and accessories.
                strength and performance blocs focus on more isolated work.
              </p>
            </div>
            <div className="border-l-2 border-accent pl-4">
